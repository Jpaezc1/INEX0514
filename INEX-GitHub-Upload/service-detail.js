const services = {
  "3d-modeling-renderings": {
    ...
    summary: "BIM-based 3D modeling and rendering support that helps clients visualize the project, review options, and make needed changes before construction begins.",
    lead: "We create 3D models through BIM workflows, including Revit-based modeling when appropriate, to turn early project ideas into clear visuals for planning conversations, client review, and construction coordination.",
    body: "INEX Studio Build uses BIM model creation and project renderings to help clients see the proposed work before materials are ordered or construction starts. These visuals can show layout, access, massing, finishes, railings, stairs, decks, ramps, and exterior details in a way that is easier to understand than flat notes alone. The goal is simple: help clients review the project, request changes, compare options, and move forward with more confidence before the build phase.",
    ideas: [
      ["BIM model creation", "Revit-based modeling support when appropriate to help organize the project visually."],
      ["Realistic renderings", "Exterior views that show scale, materials, railings, stairs, decks, ramps, and site context."],
      ["Change review before construction", "A clearer way to adjust scope, layout, and finish direction before work begins."],
      ["Client and build coordination", "Visual references that make planning conversations and construction handoff more productive."]
    ],
    gallery: [
      {
  ...
  "permit-assistance": {
    ...
    ideas: [
      ...
      ["Permit coordination", "Assisting with submission-ready information where appropriate."],
      ["Next-step guidance", "Helping clients understand what information may be needed before work proceeds."]
    ]
  },
  "engineered-drawing-coordination": {
    title: "Engineered Drawing Coordination",
    ...
    ideas: [
      ...
      ["Professional coordination", "Communication support with qualified professionals as required."],
      ["Construction handoff", "Helping translate coordinated documents into practical build planning."]
    ]
  },
  "repairs-restoration": {
    ...
    ideas: [
      ...
      ["Finish restoration", "Refreshing surfaces, details, and transitions for a cleaner result."],
      ["Preventive improvements", "Addressing small issues before they become larger construction problems."]
    ]
  },
  "remodeling": {
    title: "Remodeling",
    ...
    ideas: [
      ...
      ["Commercial updates", "Focused improvements for client-facing and operational spaces."],
      ["Finish upgrades", "Clean details, materials, and trim work that elevate the result."]
    ]
  },
  "decking-construction-repairs": {
    ...
    ideas: [
      ...
      ["Before-and-after upgrades", "Improving safety, appearance, and everyday usability."],
      ["Outdoor details", "Railings, steps, lighting coordination, and finish details."]
    ]
  },
  "concrete-work": {
    title: "Concrete Work",
    ...
    ideas: [
      ...
      ["Repair work", "Addressing cracked, worn, or uneven concrete where appropriate."],
      ["Site improvements", "Concrete elements coordinated with broader renovation or build plans."]
    ]
  },
  "carpentry": {
    title: "Carpentry",
    ...
    ideas: [
      ...
      ["Repair carpentry", "Replacing or restoring worn, damaged, or outdated components."],
      ["Custom solutions", "Project-specific construction details built around client goals."]
    ]
  },
  "interior-exterior-renovations": {
    ...
    ideas: [
      ...
      ["Commercial refreshes", "Renovation support for business spaces and client-facing areas."],
      ["Coordinated work", "Renovation planning that connects scope, budget, schedule, and finish expectations."]
    ]
  },
  "full-build-construction-services": {
    title: "Full Build / Construction Services",
    ...
    ideas: [
      ...
      ["Build coordination", "Planning, sequencing, materials, and communication through completion."],
      ["Custom construction", "Solutions tailored to the site, scope, budget, and client goals."]
    ]
  }
};
...
Object.entries(services).forEach(([key, service]) => {
  ...
  link.href = `service.html?service=${key}`;
